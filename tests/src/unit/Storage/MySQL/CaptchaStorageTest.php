...
class CaptchaStorageTest extends TestCase
{
    ...
    public static function setUpBeforeClass(): void
    {
        ...
        self::$captcha_table_name = self::$MySQLTestAsset->getCaptchaTableName();
        self::$CaptchaStorage = self::$MySQLTestAsset->getCaptchaStorage();
    }

    /**
     * @test
     * @covers FR\Captcha\Storage\MySQL\CaptchaStorage::__construct
     * 
     * @return void
     */
    ...
    /**
     * @test
     * @covers FR\Captcha\Storage\MySQL\CaptchaStorage::createDBStructure
     * 
     * @return void
     */
    public function createDBStructure()
    {
        ...
        $values = [
            ':captcha_table_name' => str_replace('`', '', strtolower(self::$captcha_table_name)),
        ];
    ...
    /**
     * @test
     * @covers FR\Captcha\Storage\MySQL\CaptchaStorage::insertCaptcha
     * 
     * @return array
     */
    ...
    /**
     * @test
     * @covers FR\Captcha\Storage\MySQL\CaptchaStorage::getCaptchaById
    ...
    /**
     * @test
     * @covers FR\Captcha\Storage\MySQL\CaptchaStorage::deleteCaptchaById
     * @depends insertCaptcha
     * 
     * @return void
     */
    ...
    /**
     * @test
     * @covers FR\Captcha\Storage\MySQL\CaptchaStorage::getExpiredCaptchas
     * 
     * @return void
     */
    ...
    /**
     * @test
     * @covers FR\Captcha\Storage\MySQL\CaptchaStorage::deleteExpiredCaptchas
     * 
     * @return void
     */
